...
/**
 * Trida umoznujici pouziti vlastni WS tridy s SkautIS tridou
 */
abstract class WSFactory {
	 ...
	 * @param array  $init        Zakladni informace pro vsechny poyadavky
	 * @param bool   $compression Ma pouzivat kompresi na prenasena data?
	 * @param bool   $profiler    Ma ukladat data pro profilovani?i
	 *
	 * @return WS;
	 */
